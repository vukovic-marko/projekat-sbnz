...
public class TestOdredjivanjeKazneZonaUsporenogSaobracaja {
    ...
    public void testNasilnicka() {
        ...
        z.setZona(Zapisnik.Zona.ZONA_USPORENOG_SAOBRACAJA);
    ...
    public void testOd11Do30() {
        ...
        assertThat(2, is(z.getPrekoracenjeBrzine().getKazneniPoeni()));
    }
